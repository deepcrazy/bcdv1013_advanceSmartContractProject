...
if (process.argv.length < 4) {
    console.error("Users-list merkle tree calculator v1.0.0");
    console.error("    node users-tree.js root <addresses-file>");
    console.error("    node users-tree.js proof <addresses-file> <address-to-prove>");
    process.exit(1);
}
